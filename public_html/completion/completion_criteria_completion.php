...
class completion_criteria_completion extends data_object {
    ...
    public function mark_complete() {
        global $DB, $USER, $CFG; //delete if no completion_repcourses here
        // Create record
...
//repcourses
		$repeatcourses = $DB->get_records('repeatcourse_records', array('maincourseid' => $this->course));
		...
		if (count($repeatcourses) > 0)
		{
			...
			$link = $CFG->wwwroot . '/mod/repeatcourse/index.php?id=' . $course_module_id . '&action=optin&maincourseid=' . $this->course;
